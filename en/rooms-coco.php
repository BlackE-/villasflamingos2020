  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          ...
          <p>There is <span><b><i>only one</i></b></span> Coco room, with a privileged location on the ground floor, within a <b><i>few steps from the seashore</i></b>. It stands out for its <b><i>indoor pool</i></b> with a large panoramic window overlooking the sea. It also has <b><i>an outdoor shower</i></b>, private terrace with chairs and table, air conditioning, minibar, safe, support table and chairs, closet, reading lamp and luggage rack.</p>
        </div>
      </section>
      ...
      <section class="reservar_section">
        <div class="container">
          <p>Maximum capacity: 2 guests<br>1 Level | All our rooms include a daily breakfast buffet for the guests.</p>
