  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          ...
          <p>These exclusive bungalows are the <b><i><span>perfect hideout for sea enthusiasts</span></i></b>, within a few steps from your room your feet will be caressed by the waves. Each of the 4 Bungalow Arena is located on the ground floor, equipped with a <b><i>private heated indoor pool</i></b>, 2 queen size beds, outdoor shower surrounded by nature and <b><i>a deck for sunset watching</i></b>. Ideal for families.</p>
        </div>
      </section>
      ...
      <section class="reservar_section">
        <div class="container">
          <p>Maximum capacity: 4 guests<br>Ground floor | All our rooms include a daily breakfast buffet for the guests.</p>
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room1">
                  <div class="box">
                    ...
                    <div class="button" id="room1_Button" role="button"><a a href="rooms-vista-mar"><span>Find Out More</span></a></div>
                  </div>
                </div>
