  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          ...
          <p>In these exclusive two-story bungalows we guarantee you will have <span><b><i>the best ocean view</i></b></span> in all of Holbox. The Cielo bungalows reflect the spirit of Villas Flamingos. There are 4 and they are located on the top floor, <b><i>ideal for receiving the sea breeze</i></b>. With their own <b><i>indoor Jacuzzi</i></b>, surrounded by hammocks hand-woven by local fishermen, and <b><i>an outdoor shower</i></b> ideal to enjoy a good bath while watching the stars.</p>
        </div>
      </section>
      ...
      <section class="reservar_section">
        <div class="container">
          <p>Maximum capacity: 2 guests<br> 2 Level | All our rooms include a daily breakfast buffet for the guests.</p>
            ...
            <div class="container">
              ...
              <div class="boxContainer" >
                ...
                <div class="boxGrid" id="room8">
                    <div class="box">
                      <a href="rooms-honeymoon-suite"><amp-img  id="room8_desktop" alt="Villas CUARTOS" src="/img/habitaciones-suitelunademiel-1.webp"  width="1080" height="720"  layout="responsive" >
                      ...
                      <p class="title" id="room8_title"><b><i>HONEYMOON</i></b> Suite</p>
                      <div class="button" id="room8_Button" role="button"><a href="rooms-honeymoon-suite"><span>Find Out More</span></a></div>
                    </div>
                </div>
              </div>
              <div class="boxContainer" >
