	...
	<header id="header_habitaciones">
	  	<div class="container ampstart-headerbar header_habitaciones">
	  		<div class="leftContainer">
	  			<div role="button" aria-label="open sidebar" on="tap:header-sidebar.toggle" tabindex="0" class="ampstart-navbar-trigger habitaciones">
	  				<div></div>
	  				<div></div>
	  				<div></div>
	  			</div>
		    ...
		    <div class="center"><a href="/en"><amp-img layout="responsive" width="67" height="45" src="../img/villasflamingos-logo-black.svg"></amp-img></amp-layout></a></div>
		      		...
		      		<li >
		      			<details class="secondOrder" title="Click for options">
					    	...
					    	<ul>
					    		...
					    		<li class="ampstart-nav-item"><a href="events-conference-rooms">Conference Rooms</a></li>
					    		<li class="ampstart-nav-item"><a href="events-yoga">Yoga</a></li>
					    	</ul>
					    </details>
		      		</li>
		      	</ul>
