  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          ...
          <p>Surrounded by a <b><i>tropical garden full of peace</i></b>, each of these two bungalows located on the ground floor have its <b><i>own heated indoor pool</i></b>, 2 queen size beds, an outdoor shower surrounded by nature and a perfect terrace to enjoy a good book. Ideal for families.</p>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="carousel_text">
            ...
            <ul class="amenidades">
              ...
              <li><p>Distance to the sea: 50m (54 yards)</p></li>
              <li><p>Surface: 32m² (344 ft²)</p></li>
              <li><p>2 Queen Size beds</p></li>
              <li><p>Private terrace</p></li>
              <li><p>Outdoor shower</p></li>
              <li><p>Private pool</p></li>
      ...
      <section class="reservar_section">
        <div class="container">
          <p>Maximum capacity: 4 guests<br>1 Level | All our rooms include a daily breakfast buffet for the guests.</p>
