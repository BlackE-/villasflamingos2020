  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          ...
          <p>Each Vista Mar has a terrace with a view of the <b><i>wonderful sea that Holbox</i></b> offers, they are ideal for families and couples in search of an unforgettable experience. Due to its attractive price this room is <b>one of our most popular</b>. Located on the first or second level.</p>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="carousel_text">
            ...
            <ul class="amenidades">
              ...
              <li><p>Distance to sea: 20m (21 yards)</p></li>
              <li><p>Surface:: 33m² (355 square feet)</p></li>
      ...
      <section class="reservar_section">
        <div class="container">
          <p>Maximum capacity: 2 guests<br>Ground floor | 1 Level | All our rooms include a daily breakfast buffet for the guests.</p>
            ...
            <div class="container">
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room1">
                  <div class="box">
                    <a href="rooms-bungalow-jardin"><amp-img  id="room1_desktop" alt="Villas CUARTOS" src="/img/habitaciones-bungalow-jardin-1.webp"  width="1080" height="720"  layout="responsive" >
                    ...
                    <div class="button" id="room1_Button" role="button"><a href="rooms-bungalow-jardin"><span>Find out more</span></a></div>
                  </div>
                </div>
                <div class="boxGrid" id="room2">
                    <div class="box">
                      <a href="rooms-bungalow-arena"><amp-img  id="room2_desktop" alt="Villas CUARTOS" src="/img/habitaciones-bungalow-arena-1.webp"  width="1080" height="720"  layout="responsive" >
                      ...
                      <div class="button" id="room2_Button" role="button"><a href="rooms-bungalow-arena"><span>Find out more</span></a></div>
                    </div>
                </div>
              </div>
              <div class="boxContainer" >
                <div class="boxGrid" id="room3">
                  <div class="box">
                    <a href="rooms-bungalow-mangle"><amp-img  id="room3_desktop" alt="Villas CUARTOS" src="/img/habitaciones-bungalow-mangle-1.webp"  width="1080" height="720"  layout="responsive" >
                    ...
                    <div class="button" id="room3_Button" role="button"><a href="rooms-bungalow-mangle"><span>Find out more</span></a></div>
                  </div>
                </div>
                <div class="boxGrid" id="room4">
                    <div class="box">
                      <a href="rooms-cacao"><amp-img  id="room4_desktop" alt="Villas CUARTOS" src="/img/habitaciones-cacao-1.webp"  width="1080" height="720"  layout="responsive" >
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room5">
                  <div class="box">
                    <a href="rooms-coco"><amp-img  id="room5_desktop" alt="Villas CUARTOS" src="/img/habitaciones-coco-1.webp"  width="1080" height="720"  layout="responsive" >
                ...
                <div class="boxGrid" id="room6">
                    <div class="box">
                      <a href="rooms-miel"><amp-img  id="room6_desktop" alt="Villas CUARTOS" src="/img/habitaciones-miel-1.webp"  width="1080" height="720"  layout="responsive" >
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room7">
                  <div class="box">
                    <a href="rooms-honeymoon-suite"><amp-img  id="room7_desktop" alt="Villas CUARTOS" src="/img/habitaciones-suitelunademiel-1.webp"  width="1080" height="720"  layout="responsive" >
