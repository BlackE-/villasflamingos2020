  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          ...
          <p>If you really <b><i><span>want to surprise your partner</span></i></b> then the Master Suite Palapa is your choice. Located on a third level for <b><i>increased privacy</i></b>, its two terraces will give you views of the <b><i>sea as well as the mangrove</i></b>. It has a jacuzzi and outdoor shower. With <b><i>attractive architectural design</i></b>, this spacious suite is unique in all of Holbox. It has a King size bed, air conditioning, minibar, safe, support table and chairs, closet, reading lamp, luggage rack.</p>
        </div>
      </section>
            ...
            <div class="container">
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room9">
                  <div class="box">
                    <a href="rooms-bungalow-cielo"><amp-img  id="room9_desktop" alt="Villas CUARTOS" src="/img/habitaciones-bungalow-cielo-1.webp"  width="1080" height="720"  layout="responsive" >
                    ...
                    <div class="button" id="room9_Button" role="button"><a href="rooms-bungalow-cielo"><span>Find Out More</span></a></div>
                  </div>
                </div>
              </div>
            </div>
