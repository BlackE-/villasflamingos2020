  	...
  	<div class="container ampstart-headerbar">
	    ...
	    <div class="rightContainer">
			<div class="buttonContainer">
		    	<div class="available desktop" on="tap:reservar" role="button"><span>BOOK</span></div>
	...
	<amp-sidebar id="header-sidebar" class="ampstart-sidebar px3  " layout="nodisplay">
		...
		<nav class="ampstart-sidebar-nav ampstart-nav">
		    ...
		    <details class="firstOrder" title="Click para ver opciones">
		   	...
		   	<ul>
		      <li class="ampstart-nav-item"><a class="ampstart-nav-link" on="tap:header-sidebar.close" href="contact">Contact</a></li>
