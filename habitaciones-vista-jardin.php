            ...
            <div class="container">
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room1">
                  <div class="box">
                    <amp-img class="desktop" id="room1_desktop" alt="Villas CUARTOS" src="img/habitaciones-vista-mar-1.webp"  width="1080" height="720"  layout="responsive" media="(min-width: 645px)">
                    ...
                    <amp-img class="mobile" id="room1_mobile" alt="Villas CUARTOS" src="img/habitaciones-vista-mar-1-mobile.webp" width="360" height="240" layout="responsive" media="(max-width: 644px)">
