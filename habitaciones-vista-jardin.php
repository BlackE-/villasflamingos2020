            ...
            <amp-carousel lightbox id="carouselHabitaciones" type="slides" width="1080" height="720" layout="responsive" controls loop autoplay delay="5000" role="region" aria-label="Tipo Habitaciones">
              <div class="carouselDiv vista-jardin">
                  <div class="imgContainer">
                    <amp-img src="img/habitaciones-vista-jardin-1.jpg" width="1080" height="720" layout="responsive"></amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img src="img/habitaciones-vista-jardin-2.jpg" width="1080" height="720" layout="responsive"></amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img src="img/habitaciones-vista-jardin-3.jpg" width="1080" height="720" layout="responsive"></amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img src="img/habitaciones-vista-jardin-4.jpg" width="1080" height="720" layout="responsive"></amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img src="img/habitaciones-vista-jardin-5.jpg" width="1080" height="720" layout="responsive"></amp-img>
                  </div>
              </div>
            </amp-carousel>
          </div>
            ...
            <div class="container">
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room1">
                  <div class="box">
                    <amp-img class="desktop" id="room1_desktop" alt="Villas CUARTOS" src="img/habitaciones-vista-mar-1.webp"  width="1080" height="720"  layout="responsive" >
                ...
                <div class="boxGrid" id="room2">
                    <div class="box">
                      <amp-img class="desktop" id="room2_desktop" alt="Villas CUARTOS" src="img/habitaciones-bungalow-jardin-1.webp"  width="1080" height="720"  layout="responsive" >
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room3">
                  <div class="box">
                    <amp-img class="desktop" id="room3_desktop" alt="Villas CUARTOS" src="img/habitaciones-bungalow-arena-1.webp"  width="1080" height="720"  layout="responsive" >
                ...
                <div class="boxGrid" id="room4">
                    <div class="box">
                      <amp-img class="desktop" id="room4_desktop" alt="Villas CUARTOS" src="img/habitaciones-bungalow-mangle-1.webp"  width="1080" height="720"  layout="responsive" >
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room5">
                  <div class="box">
                    <amp-img class="desktop" id="room5_desktop" alt="Villas CUARTOS" src="img/habitaciones-cacao-1.webp"  width="1080" height="720"  layout="responsive" >
                ...
                <div class="boxGrid" id="room6">
                    <div class="box">
                      <amp-img class="desktop" id="room6_desktop" alt="Villas CUARTOS" src="img/habitaciones-coco-1.webp"  width="1080" height="720"  layout="responsive" >
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room7">
                  <div class="box">
                    <amp-img class="desktop" id="room7_desktop" alt="Villas CUARTOS" src="img/habitaciones-miel-1.webp"  width="1080" height="720"  layout="responsive" >
                ...
                <div class="boxGrid" id="room8">
                    <div class="box">
                      <amp-img class="desktop" id="room8_desktop" alt="Villas CUARTOS" src="img/habitaciones-suitelunademiel-1.webp"  width="1080" height="720"  layout="responsive" >
              ...
              <div class="boxContainer" >
                <div class="boxGrid" id="room9">
                  <div class="box">
                    <amp-img class="desktop" id="room9_desktop" alt="Villas CUARTOS" src="img/habitaciones-bungalow-cielo-1.webp"  width="1080" height="720"  layout="responsive" >
                ...
                <div class="boxGrid" id="room10">
                    <div class="box">
                      <amp-img class="desktop" id="room10_desktop" alt="Villas CUARTOS" src="img/habitaciones-suitemasterpalapa-1.webp"  width="1080" height="720"  layout="responsive" >
