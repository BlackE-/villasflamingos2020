    ...
    gsap.to('.controls', {scrollTrigger: ".Bungalow_Tipo_carousel",opacity:1,duration:1.5}); 
    gsap.to('.carousel', {scrollTrigger: ".Bungalow_Tipo_carousel",opacity:1,y:0,duration:1.5}); 
