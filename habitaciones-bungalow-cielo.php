  ...
  <div class="indexContainer">
      <section class="habitaciones_cuartos_texto">
        <div class="container" id="text1">
          <h1>Bungalow <span><b>CIELO</b></span></h1>
          <p>En estos exclusivos búngalos de dos niveles te garantizamos <SPAN><B><I>la mejor vista al mar</I></B></SPAN> de todo Holbox. Los búngalos Cielo <B><I>son el reflejo del espíritu de Villas Flamingos.</I></B> Son 4 y están ubicados en planta alta, ideales para recibir la brisa del mar. Cuenta con su propio <b><i>jacuzzi interior,</i></b> rodeado por hamacas tejidas a mano por pescadores locales, <b><i>una ducha al exterior</i></b> ideal para disfrutar de un buen baño mientras ves las estrellas.</p>
        </div>
      </section>
            ...
            <amp-carousel id="carouselHabitaciones" type="slides" width="1080" height="720" layout="responsive" controls loop autoplay delay="5000" role="region" aria-label="Tipo Habitaciones">
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-1.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-1.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-1-mobile.webp" width="360" height="240" layout="responsive">
                        <amp-img fallback src="img/habitaciones-bungalow-cielo-1-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                      </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-2.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-2.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-2-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-2-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-3.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-3.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-3-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-3-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-4.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-4.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-4-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-4-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-5.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-5.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-5-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-5-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-6.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-6.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-6-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-6-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-7.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-7.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-7-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-7-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-8.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-8.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-8-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-8-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-9-carousel.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-9-carousel.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-9-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="|img/habitaciones-bungalow-cielo-9-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
              <div class="carouselDiv">
                  <div class="imgContainer">
                    <amp-img class="desktop" src="img/habitaciones-bungalow-cielo-10-carousel.webp" width="1080" height="720" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-10-carousel.jpg" width="1080" height="720" layout="responsive"></amp-img>
                    </amp-img>
                    <amp-img class="mobile" src="img/habitaciones-bungalow-cielo-10-mobile.webp" width="360" height="240" layout="responsive">
                      <amp-img fallback src="img/habitaciones-bungalow-cielo-10-mobile.jpg" width="360" height="240" layout="responsive"></amp-img>
                    </amp-img>
                  </div>
              </div>
            </amp-carousel>
      ...
      <section class="reservar_section">
        <div class="container">
          <p>Capacidad máxima: 2 personas<br> 2 Niveles  |  Todos nuestros cuartos incluyen desayuno bufete.</p>
